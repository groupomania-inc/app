...
const SignInPage: NextPage = () => {
    ...
    const onSubmit = (credentials: SignInInput) => {
        ...
        signIn("credentials", {
            ...
            if (res?.error)
                if (res.status === 401) setError("Indentifiants invalides");
    ...
    return (
        <>
            ...
            <section className="bg-white">
                <div className="xs:px-6 mx-auto flex h-screen flex-col items-center justify-center py-8 lg:py-0">
                    <header className="mb-6 flex items-center text-2xl font-semibold text-white">
                        <svg height="40" viewBox="0 0 485 78">
                            <g
                                fill="#fd2d01"
                                transform="matrix(4.569687698175228,0,0,4.569687698175228,96.32992012448554,5)"
                            >
                    ...
                    <div className="w-full max-w-md rounded-lg border border-gray-200 bg-gray-50 shadow md:mt-0 xl:p-0">
                        <div className="space-y-4 p-6 sm:p-8 md:space-y-6">
                            <h1 className="text-xl font-bold leading-tight tracking-tight text-zinc-800 md:text-2xl">
                            ...
                            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
                                <div>
                                    ...
                                    <input
                                        id="email"
                                        placeholder="utilisateur@groupomania.com"
                                        disabled={isLoading}
                                        className={`block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-zinc-800 sm:text-sm ${
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="••••••••"
                                        disabled={isLoading}
                                        className={`block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-zinc-800 focus:border-blue-500 focus:ring-blue-500 sm:text-sm ${
                                ...
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className="w-full rounded-lg px-5 py-2.5 text-center text-sm font-medium text-zinc-800 focus:outline-none focus:ring-4"
                                >
                                    {isLoading ? <LoadingSpinner className="h-4" /> : "Se connecter"}
                                </button>
                                <p className="text-sm font-light text-zinc-600">
                                    Pas encore de compte ?{" "}
                                    <Link href="/auth/sign-up">
                                        <span className="animate-spin cursor-pointer font-medium text-blue-600 hover:underline">
                                            Créer un compte
                                        </span>
                                    </Link>
                                </p>
