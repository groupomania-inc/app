...
const SignUpPage: NextPage = () => {
    ...
    return (
        <>
            <Head>
                <title>Créer un compte | Groupomania</title>
            </Head>
                            ...
                            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
                                <div>
                                    ...
                                    <div className="text-xs text-red-500">
                                        {errors.email?.message || authError?.message}
                                    </div>
                                </div>
                                <div>
                                    <label
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        disabled={isLoading}
                                        className={`block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-zinc-800 focus:border-blue-500 focus:ring-blue-500 sm:text-sm ${
                                            errors.confirm ? "border-red-500 focus:outline-red-500" : ""
                                        }`}
                                        {...register("confirm")}
                                    />
                                    <div className="text-xs text-red-500">{errors.confirm?.message}</div>
                                </div>
                                <button
                                    type="submit"
                                    className="w-full rounded-lg px-5 py-2.5 text-center text-sm font-medium text-zinc-800 focus:outline-none focus:ring-4"
                                >
                                    {isLoading ? <LoadingSpinner className="h-4" /> : "Créer un compte"}
                                </button>
