...
const NewPostPage: NextPage = () => {
    ...
    } = trpc.useMutation(["posts.new"], {
        onSuccess: () => router.push("/"),
    });
    const { formState, handleSubmit, register } = useForm<CreatePostInput>({
                        ...
                        >
                            ...
                            <main className="min-h-[1.6em] w-full pt-3 pb-4">
                                <textarea
                                    ...
                                    {...register("body")}
                                />
                                <p className="text-xs text-red-500">{errors.body && errors.body.message}</p>
                            </main>
